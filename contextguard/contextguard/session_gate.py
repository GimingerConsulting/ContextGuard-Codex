...
def build_session_gate(root: Path, *, include_surface: bool = False, brief_budget: int = 100) -> str:
    ...
    parts: list[str] = [
        ...
        "Use capture for high-volume tests, builds, logs, diffs, and broad search; keep small targeted reads direct; read exact source once; expand archives only for missing evidence.",
