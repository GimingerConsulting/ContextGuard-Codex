...
- Release: pushed main to the authoritative `GimingerConsulting/ContextGuard` repository and installed/enabled plugin build `0.9.0+codex.20260712123616`. The checkout's stale BurliNYC `origin` was corrected to GimingerConsulting to prevent future misdirected pushes.
